...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\begin{axis}[legend pos=outer north east,xlabel={Nummer des Termins},ylabel={durchschnittliche Bewertung}, ymax = 4, ymin = 0]
			\addplot[mark=*,yellow]
			coordinates {
				(3,1) (5,1) (6,0) (7,0) (8,0) (11,1) (12,0)
			};
...
Einen durchwachsenen Verlauf ist bei dem Kind der Gruppe Panda sichtbar. Die Werte sind generell unterdurchschnittlich und schwanken zwischen einem Maxima von 1 und einem Minima von 0 ohne Zwischenstufen. Dies bedeutet, dass das Kind entweder gar nicht in der Lage war oder nur ein wenig, gute Bewertungen in diesen Bereichen des emergenten Denkens zu erzielen.
...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\begin{axis}[legend pos=outer north east,xlabel={Nummer des Termins},ylabel={durchschnittliche Bewertung}, ymin = 0, ymax = 4]
			\addplot[mark=*,yellow]
			coordinates {
				(3,0) (5,.75) (6,.5) (7,.5) (8,.5) (11,.75) (12,.75)
			};
...
Im Verlaufe des Kurses verschlechterte sich die durchschnittliche kreative Haltung aller Kinder. Der Abfall ist zwar nur sehr gering, jedoch verschlechtert sich die Haltung.\\
...
Der Verlauf der Entwicklung im Bereich der Dekomposition ist bei allen Kindern relativ ähnlich, was daran erkannt werden kann, dass alle Tiere sehr nahe zusammenliegen. Generell schnitten die Kinder nicht sehr gut in diesem Bereich ab, alle Werte liegen im Bereich zwischen 1 und 2, inklusive der Grenzen des Bereichs.\\
...
Abgesehen von der Gruppe der Pandas sind alle verschiedenen Persönlichkeitsgruppen nahe am Durchschnitt, es gibt nur wenig Differenz zwischen einem Typ und dem Durchschnitt an einer Stelle. Der generelle Trend geht hierbei mehr oder weniger in die positive Richtung.\\
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption[Vergleich Entwicklung Dekomposition beider Veranstaltungen]{Vergleich der Entwicklung der Fähigkeit der Dekomposition beider Veranstaltungen}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption[Vergleich Entwicklung algorithmisches Denken beider Veranstaltungen]{Vergleich der Entwicklung des algorithmischen Denkens beider Veranstaltungen}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption[Vergleich Entwicklung Evaluation beider Veranstaltungen]{Vergleich der Entwicklung der Fähigkeit der Evaluation beider Veranstaltungen}
\end{figure}
