...
Für die Bewertung der Kinder wurden insgesamt bis zu 252 Felder pro Kind analysiert und in Zahlen konvertiert, dies wurde insgesamt acht Mal durchgeführt, so dass am Ende bis zu 2016 Felder bewertet wurden. Dies ist nur die Maximalangabe, da Kinder an Terminen nicht anwesend waren oder leere Felder in den Ausgangsbögen vorhanden waren, weshalb nicht alle Felder bewertet werden konnten. Mithilfe der obigen Ergebnisse kann nun verifiziert werden, ob das definierte Bewertungsschema gut funktioniert. Dies soll mithilfe der Interrater-Reliabilität überprüft werden.\\

Um sagen zu können, wie gut die Metrik ist, benutzen wir eine Skala nach \citeauthor{cohen_1960}. Mithilfe der Formel $ \kappa = \frac{p_{0}-p_{c}}{1-p_{c}} $. Diese Formel wurde von \citeauthor{cohen_1960} in \citetitle{cohen_1960} definiert. P_{0} steht dabei für die Menge, in der sich die beiden Bewerter einig sind, P_{c} steht für die erwartete Menge an Übereinstimmung. Um P_{0} berechnen zu können, wird folgende Formel angewandt: $ \frac{(Anzahl aller Übereinstimmungen)}{Gesamtanzahl überprüfter Felder} $.

\begin{table}[H]
	\begin{tabular}{|
			>{\columncolor[HTML]{C0C0C0}}l |c|c|}
		\hline
		Kind & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}Anzahl bewerteter Felder} & \multicolumn{1}{l|}{\cellcolor[HTML]{C0C0C0}Anzahl Übereinstimmungen} \\ \hline
		Jonas     & 39  & 87  \\ \hline
		Mario     & 84  & 120 \\ \hline
		Sara      & 71  & 105 \\ \hline
		Benny     & 74  & 140 \\ \hline
		Henriette & 97  & 172 \\ \hline
		Moritz    & 48  & 102 \\ \hline
		Lulu      & 64  & 104 \\ \hline
		Heinz     & 63  & 124 \\ \hline
		Gesamt    & 540 & 954 \\ \hline
	\end{tabular}
	\caption{Übereinstimmungen bei der Bewertung}
