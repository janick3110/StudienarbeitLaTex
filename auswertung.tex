...
Die Entwicklung von Jonas zeigt eine sehr konstante Teamfähigkeit. Der Durchschnitt der Bewertungen aus dem vorherigen Kapiteln wies wie in der obenstehenden Abbildung zu sehen Werte um 2.5 auf, welche damit als sehr gut einzuschätzen sind. Von einer Entwicklung im Bereich des Teamworks kann aber aufgrund seiner Konstanz nicht gesprochen werden. Im Bereich divergentes Denken hat Jonas zu Beginn einen sehr niedrigen Wert aufgewiesen,lag nahe 0. Im Verlauf hat sich Jonas gesteigert und im Maximum einen Wert nahe 1 erreicht, lediglich zum Schluss fiel der Wert wieder auf das Anfangsniveau ab.Betrachtet man wie sich das emergente Denken entwickelt hat, beobachtet man einen anfangs konstanten Verlauf der zur Hälfte der Termine langsam ansteigt und im Schnitt bei ungefähr bei 2.25 liegt.Jonas Kreativität ist insgesamt auf einem hohen Level mit Werten um die 3, sinkt im Verlauf jedoch auf ungefähr 2.5 ab. Allerdings muss hier beachtet werden, dass nur wenige Werten zur Kreativität vorhanden sind. Als letztes gilt es noch die Werte zum konvergenten Denken auszuwerten. Hier sieht man einen fast konstanten Verlauf mit Werten von 2.5, es gibt lediglich zwei Ausreißer bei 3. \\Insgesamt kann man festhalten, dass Jonas in allen Bereichen mit Ausnahme des divergenten Denkens gute Werte (im Schnitt ungefähr 2.5) aufweist. Beim divergenten Denken kommt er allerdings nicht über einen Wert von 1 hinaus.      
