...
Um sagen zu können, wie gut die Metrik ist, benutzen wir eine Skala nach \citeauthor{cohen_1960}. Mithilfe der Formel 
$\kappa = \frac{p_{0}-p_{c}}{1-p_{c}}$.
Diese Formel wurde von \citeauthor{cohen_1960} in \citetitle{cohen_1960} definiert. $P_{0}$ steht dabei für die Menge, in der sich die beiden Bewerter einig sind, $P_{c}$ steht für die erwartete Menge an Übereinstimmung. Um $P_{0}$ berechnen zu können, wird folgende Formel angewandt:  
$\frac{Anzahl \; aller \; Übereinstimmungen}{Gesamtanzahl \; überprüfter \; Felder}$.
