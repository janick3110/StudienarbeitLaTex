...
\section{Ergebnisse des Computational Thinking Test}\label{sec:ErgebnisseCTT}
	...
	\begin{table}[H]
		...
		\end{tabular}
		\caption{Erreichte Punkte pro Kategorie des CTt}
	\end{table}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			\begin{axis}[
				ybar,ymin=0,
				symbolic x coords={Typ 1, Typ 2, Typ 3, Typ 4, Typ 5, Typ 6, Typ 7},xtick={Typ 1, Typ 2, Typ 3, Typ 4, Typ 5, Typ 6, Typ 7
				}, scale = 2,legend pos=outer north east
				]
				%Border Collie
				\addplot[red!20!black,fill=red!80!white] coordinates
				{(Typ 1,2.5) (Typ 2,2.5) (Typ 3,2.5) (Typ 4,0) (Typ 5,0) (Typ 6,0)(Typ 7,0)};
				%Erdmännchen 9,166666667	8	7,142857143	7,5	5	6,666666667
				\addplot[blue!20!black,fill=blue!80!white] coordinates
				{(Typ 1,5) (Typ 2,3.75) (Typ 3,3.75) (Typ 4,1.25) (Typ 5,5) (Typ 6,0)(Typ 7,0)};
				%Elefant
				\addplot[green!20!black,fill=green!80!white] coordinates
				{(Typ 1,10) (Typ 2,5) (Typ 3,3.75) (Typ 4,2.5) (Typ 5,5) (Typ 6,1.25)(Typ 7,0 )};
				%Panda
				\addplot[yellow!20!black,fill=yellow!80!white] coordinates
				{(Typ 1,5) (Typ 2,0) (Typ 3,0) (Typ 4,0) (Typ 5,5) (Typ 6,2.5)(Typ 7, 2.5)};
				\addlegendentry{Border Collie}
				\addlegendentry{Erdmännchen}
				\addlegendentry{Elefant}
				\addlegendentry{Panda}
