...
In den folgenden Abschnitten werden mithilfe des Werks \citetitle{jung_2014} Jungs Kategorien sowie die Typen kurz zusammengefasst. Zusätzlich ordnet \citeauthor{mccaulley_myers-briggs_1974} diesen Kategorien in seiner Arbeit \citetitle{mccaulley_myers-briggs_1974} verschiedene Eigenschaften im Bezug auf den Lernprozess zu. \cite{mccaulley_myers-briggs_1974}
...
\begin{tabular}{|l|l|l|}
	...
	Interessiert an &
	\begin{tabular}[c]{@{}l@{}}Etwas mit greifbaren \\ Objekten machen\end{tabular} &
	\begin{tabular}[c]{@{}l@{}}Sprachlich, gesprochen \\ oder geschrieben\end{tabular} \\ \hline
	\begin{tabular}[c]{@{}l@{}}Bevorzugen Wahrnehmung \\ durch\end{tabular} &
	solide &
	schnell \\ \hline
	Typische Herangehensweise &
	Stichwortartig &
	genereieren von Hypothesen \\ \hline
	Arbeitsweise &
	gleichmäßig, Schritt für Schritt &
	In energetischen Ausbrüchen \\ \hline
	\begin{tabular}[c]{@{}l@{}}Generieren eines neuen\\ Gedankens\end{tabular} &
	\begin{tabular}[c]{@{}l@{}}Schritte aus der gegenwärtigen\\ Erfahrung\end{tabular} &
	Intuitive Sprünge \\ \hline
	Lesen &
	Weniger interessiert und ausgeprägt &
	Mehr Interesse und Leistung \\ \hline
	Vortrefflichkeit rührt aus &
	praktischem Realismus &
	Vorstellung der Zukunft \\ \hline
	\begin{tabular}[c]{@{}l@{}}Testleistung:\\ Geschrieben Essay\\ Fassungsvermögen\\ Zeitbegrenzt\\ Energie\end{tabular} &
	\begin{tabular}[c]{@{}l@{}}\ \\ schneiden schlechter ab\\ schneiden schlechter ab\\ schneiden schlechter ab\\ mehr Zugewinn über die Zeit\end{tabular} &
	\begin{tabular}[c]{@{}l@{}}\ \\ schneiden besser ab\\ schneiden besser ab\\ schneiden besser ab\\ weniger Zugewinn über die Zeit\end{tabular} \\ \hline
\end{tabular}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.6\textheight,angle=0]{img/cctt}}
	\caption[Beispielhafte Frage des \acrshort{bctt}]{Beispielhafte Frage des \acrshort{cctt} \cite{cctt}}
	\label{img:ccttQuestion}
\end{figure}
