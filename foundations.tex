...
\section{Die FIRST LEGO League}
Bei der FIRST LEGO League handelt es sich um Wettbewerbe, die von einer Kooperation von \gls{Lego} und \gls{First} organisiert werden. Das Ziel dieser Wettbewerbe ist es Kinder und Jugendliche für eine Laufbahn im \gls{MINT}-Bereich zu motivieren. Mittlerweile besteht die FIRST LEGO League aus zwei Wettbewerben. Die FIRST LEGO League Explore für Kinder im Grundschulalter (6-10 Jahre) und die FIRST LEGO League Challenge für Kinder und Jugendliche der weiterführenden Schulen. Diese beiden Wettbewerbe haben ein gemeinsames Saisonthema, welches in dieser Saison (2021/22) das Thema \textit{Transport} war.
